...
$(document).ready(function () {
	$('.menu-icon-01').on("click", function (e) {
...
$(document).ready(function () {
	...
	$(".side-container>.nav-link>li").hover(function () {	
		$('.side-container2').addClass('submenu-show');
		$(this).children('.side-container>.nav-link>li>ul').addClass('submenu-show');
	
	});
		
		$(".side-container>.nav-link>li").mouseleave(function(){
			$('.side-container2').removeClass('submenu-show');
			$('.side-container>.nav-link>li>ul').removeClass('submenu-show').fadeOut(1000);
		});
...
//  $( ".mob-menu ul li ul" ).slideToggle( "slow" );
	$(this).children('.mob-menu ul li ul').slideToggle( "slow" );
});

$('.start-link').on("click", function (e) {
	
	$('.ask-demo-container').addClass('open');
	$('body').addClass('menu-opened');
	
});
$('.all__btn').on("click", function (e) {
	e.preventDefault();
	$('.footer-popup').addClass('open');
	$('body').addClass('menu-opened');
});
	 ...
	 // var width-big = $('.width-big');
	  ...
	  $(document).on("click",function() {
                ...
                if(isOpen == false){
                    ...
                    isOpen = false;
					 cancelBtn.removeClass('cancel-btn-active');
					$( ".justify-content-between").removeClass( "width-big" );
                } else {
					cancelBtn.addClass('cancel-btn-active');
                }
            });
...
$( ".searchbox-icon" ).click(function() {
  ...
  $( ".t1").toggleClass( "menu-hide" );
});

$( ".searchbox-icon" ).click(function() {

  $( ".justify-width").addClass( "width-big" );
});

$( ".cancel-btn-active" ).click(function() {

  $( ".justify-width").removeClass( "width-big" );
});

$( ".searchbox-icon" ).click(function() {

  $( ".navbar-brand ").addClass( "logo-hide" );
});

$( ".cancel-btn" ).click(function() {

  $( ".navbar-brand").removeClass( "logo-hide" );
});
